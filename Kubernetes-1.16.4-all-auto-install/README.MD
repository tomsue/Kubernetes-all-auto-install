# Kubernetes-1.16.4-all-auto-install

### 项目介绍
个人整理的Centos7.x +Docker3:18.09.9-3+ Kubernetes-1.16.4 + Dashboard-1.8.3 无 CVE-2018-1002105 漏洞的master,node节点全自动快速一键安装部署文件，适用于测试环境，生产环境的快速安装部署
